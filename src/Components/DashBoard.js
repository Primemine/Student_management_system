        ...
        <div className="bg-green-600 border rounded shadow p-2">
          <div className="flex flex-row items-center">
            ...
            <div className="flex-1 text-right">
              ...
              <h3 className="text-white text-3xl">3249<span className="text-green-400"><i
      ...
      <div className="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pl-2">
        <div className="bg-blue-600 border rounded shadow p-2">
          <div className="flex flex-row items-center">
            ...
            <div className="flex-1 text-right">
              <h5 className="text-white">Total Teachers</h5>
              <h3 className="text-white text-3xl">13 <span className="text-blue-400"><i className="fas fa-caret-up"></i></span>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-black border rounded shadow p-2">
          <div className="flex flex-row items-center">
            ...
            <div className="flex-1 text-right pr-1">
              <h5 className="text-white">Workers</h5>
        ...
        <div className="bg-pink-600 border rounded shadow p-2">
          <div className="flex flex-row items-center">
            ...
            <div className="flex-1 text-right">
              ...
              <h3 className="text-white text-3xl">3 <span className="text-pink-400"><i className="fas fa-caret-up"></i></span>
              </h3>
            </div>
          </div>
        </div>
